...
lowest_note = midi_manipulation.lowerBound  # the index of  lowest note on the piano roll
highest_note = midi_manipulation.upperBound  # the index of the highest note on the piano roll
note_range = highest_note - lowest_note  # the note range

num_timesteps = 150  # This is the number of timesteps that we will create at a time
...
with tf.Session() as sess:
    ...
    for i in range(sample.shape[0]):
        ...
        #save the vector as a midi file
        midi_manipulation.noteStateMatrixToMidi(S, "output/generated_music{}".format(i))
        #z=np.append(S, S+1, axis=0)
